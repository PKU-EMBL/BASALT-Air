...
binset and quality summary after data feeding.
...
from basalt.core.data_feeding import *
...
def data_feeding_main(assembly_list, datasets, num_threads, data_feeding_folder,
    ...
    if last_step < 15:
        ...
        try:
            ...
            xyzzz=1
        multiple_assembly_comparator_main(assembly_list2, binsets_list2, coverage_list2, PE_datasets, step, num_threads)
        os.system('rm -rf CC_*')
        f_cp_m=open('Basalt_checkpoint.txt', 'a')
